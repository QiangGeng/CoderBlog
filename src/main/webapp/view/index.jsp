...
<head>
    ...
    <!--<![endif]-->
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/assets/view/css/layouts/blog-old-ie.css">
    <![endif]-->
    <!--[if gt IE 8]><!-->
    <link rel="stylesheet" href="${pageContext.request.contextPath }/assets/view/css/layouts/blog.css">
    <!--<![endif]-->
</head>
<body>
                ...
                <section class="post">
                    <header class="post-header">
                        <img width="48" height="48" alt="Tilo Mitra&#x27;s avatar" class="post-avatar"
                             src="${pageContext.request.contextPath }/assets/view/img/common/tilo-avatar.png">
                ...
                <section class="post">
                    <header class="post-header">
                        <img width="48" height="48" alt="Eric Ferraiuolo&#x27;s avatar" class="post-avatar"
                             src="${pageContext.request.contextPath }/assets/view/img/common/ericf-avatar.png">
                ...
                <section class="post">
                    <header class="post-header">
                        <img width="48" height="48" alt="Reid Burke&#x27;s avatar" class="post-avatar"
                             src="${pageContext.request.contextPath }/assets/view/img/common/reid-avatar.png">
                ...
                <section class="post">
                    ...
                    <div class="post-description">
                        <p>
                            ...
                            download it directly, or pull it in via npm. We’ve also updated the YUI Library website with
            ...
            <div class="footer">
                <div class="pure-menu pure-menu-horizontal">
                    <ul>
                        ...
                        <li class="pure-menu-item"><a href="http://github.com/yahoo/pure/"
